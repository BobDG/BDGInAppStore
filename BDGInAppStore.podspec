Pod::Spec.new do |s|
  ...
  s.license 	   = 'MIT'
  s.description    = 'Lightweight wrapper around storekit for opening AppStore screens from within the App, taking possible affiliateID's en campaign tokens into account'
